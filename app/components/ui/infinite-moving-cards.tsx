  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] bg-black/40 flex  max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-purple-700 px-8 py-6 md:w-[450px] justify-between"
            key={item.name}
          >
            <blockquote>
              <div
